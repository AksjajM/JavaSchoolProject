...
public class StackTests<T> {
    ...
    @Test
    void peek_should_return_top_and_should_not_remove_top() throws Exception {
        stack.push(firstElement);
    ...
    @Test
    void pop_should_return_top_and_should_update_top_if_stack_not_empty() throws Exception {
        stack.push(firstElement);
    ...
    @Test
    void pop_should_reduce_size() throws Exception {
        stack.push(firstElement);
        stack.push(secondElement);
    ...
    @Test
    void sort_should_return_null_when_argument_null() throws Exception {
    ...
    @Test
    void sort_should_order_elements_correctly() throws Exception {
